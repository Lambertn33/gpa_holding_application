        ...
        <div class="row">
            <div class="col-md-10 offset-md-1" style="padding:20px" id="card">
                <div class="card"  style="border:2px solid #000">
                    ...
                    $message="";
                    if($year && !$month ){
                        $message = 'Proforma Report of the Year '. $year .'';
                    }elseif($year && $month){
                        switch ($month) {
                            case '01':
                        ...
                        $message = 'Proforma Report of the Period of '. $monthInWords .' '. $year .'';
                    }elseif($startingDate && $endingDate)
                    $message = 'Proforma Report of the Period from '. $startingDate .' to '. $endingDate .'';
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($proformaToReport as $report)
                                        @php
                                       ...
                                       @endphp
                                        <tr>
                                            <td>{{ $counter }}</td>
                                            <?php $counter++ ?>
                                            <td>{{ $report->client->client_Names }}</td>
                                            <td>{{ $report->date }}</td>
                                            <td>{{ $report->status }}</td>
                                            <td>{{ $totalAmount }}</td>
