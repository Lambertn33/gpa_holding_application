    ...
    $.fn.richText = function (options) {
        ...
        $editor.find(".richText-help").on("click", function () {
            ...
            if ($editor) {
                ...
                var $inner = $('<div />', {style: 'position:relative;margin:60px auto;box-shadow:8px 12px 18px 0 rgba(130, 130, 134, 0.05);padding:20px;background-color:#fff;width:70%;border-radius:8px;font-size:small;'});
