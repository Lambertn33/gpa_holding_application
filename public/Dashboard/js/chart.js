( function ( $ ) {
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                data: [ 0, 7, 3, 5, 2, 10, 7 ],
                label: "Expense",
                backgroundColor: 'rgba(66, 91, 214,.6)',
                borderColor: 'rgba(66, 91, 214,0.6)',
                borderWidth: 3.5,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: 'rgba(66, 91, 214,0.9)',
                    }, ]
        },
        options: {
            responsive: true,
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                ...
                borderColor: 'rgb(66, 91, 214)',
                borderWidth: 3,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: '#425bd6',
                    }, {
                label: "Electronics",
                data: [ 0, 50, 40, 80, 40, 79, 120 ],
                backgroundColor: 'transparent',
                borderColor: 'rgb(2, 195, 238)',
                borderWidth: 3,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: '#02c3ee',
                    } ]
        },
        options: {
            responsive: true,
            ...
            datasets: [
                {
                    ...
                    borderColor: "rgba(66, 91, 214,.9)",
                    borderWidth: "1",
                    backgroundColor: "rgba(66, 91, 214,.7)",
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [
			{
				...
				borderColor: "rgba(66, 91, 214, 0.9)",
				borderWidth: "0",
				backgroundColor: "rgba(66, 91, 214, 0.7)"
						},
			{
				label: "My Second dataset",
            ...
            datasets: [
                {
                    ...
                    borderColor: "rgba(66, 91, 214, 0.6)",
                    borderWidth: "1",
                    backgroundColor: "rgba(66, 91, 214, 0.4)"
                            },
                {
                    label: "My Second dataset",
            ...
            datasets: [
                {
                    ...
                    borderColor: "rgba(66, 91, 214, 0.9)",
                    borderWidth: "0",
                    backgroundColor: "rgba(66, 91, 214, 0.8)"
                            }
                        ]
        },
        options: {
	...
	gradientStroke1.addColorStop(0, '#425bd6');
	gradientStroke1.addColorStop(1, '#425bd6');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 360);
	gradientStroke2.addColorStop(0, '#02c3ee');
	gradientStroke2.addColorStop(1, '#02c3ee');
	...
	gradientStroke.addColorStop(0, 'rgba(66, 91, 214,0.6)');
	gradientStroke.addColorStop(1, 'rgba(66, 91, 214,0.6)');
    var myChart = new Chart( myCanvas, {
		type: 'line',
		data: {
            ...
            datasets: [ {
				...
				borderColor: 'rgba(66, 91, 214)',
				pointBackgroundColor:'#fff',
				pointHoverBackgroundColor:gradientStroke,
				pointBorderColor :'#425bd6',
	...
	gradientStroke1.addColorStop(0, '#02c3ee');
	gradientStroke1.addColorStop(1, '#02c3ee');
	...
	gradientStroke.addColorStop(0, '#425bd6');
	gradientStroke.addColorStop(1, '#425bd6');
    var myChart = new Chart(ctx, {
		type: 'line',
		data: {
    ...
    var myChart = new Chart( myCanvas, {
        ...
        data: {
            ...
            datasets: [ {
				...
				backgroundColor: 'rgba(66, 91, 214, 0.2)',
				borderColor: gradientStroke1,
				pointBackgroundColor:'#fff',
				pointHoverBackgroundColor:gradientStroke1,
				pointBorderColor :gradientStroke1,
